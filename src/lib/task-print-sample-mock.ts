...
export const MATH_PRINT_SAMPLES: PrintQuestion[] = [
  ...
  },
  {
    id: "math-sample-8",
    subject: "math",
    stem: "다음 중 두 변량 사이의 상관관계가 양의 상관관계인 것을 고르세요.",
    choices: [
      "수학 문제집의 오답 개수와 수학 시험 점수",
      "하루 중 게임 시간과 하루 중 독서 시간",
      "결석 횟수와 학기말 지필평가 성적",
      "일주일 동안의 수학 공부 시간과 기말고사 수학 성적",
      "통학 거리와 아침 등교 준비 시간"
    ],
    answer: "결석 횟수와 학기말 지필평가 성적",
    explanation: "④ 일주일 동안의 수학 공부 시간과 기말고사 수학 성적은 한쪽이 증가함에 따라 다른 쪽도 대체로 증가하는 경향이 있으므로 양의 상관관계입니다.<br/>①, ③은 음의 상관관계이며, ②는 대체로 음의 상관관계에 가깝고, ⑤는 뚜렷한 상관관계를 보이지 않습니다.<br/><br/>따라서 양의 상관관계인 것은 ④입니다."
  },
  {
    id: "math-sample-9",
    subject: "math",
...
export const SCIENCE_PRINT_SAMPLES: PrintQuestion[] = [
  ...
  },
  {
    ...
    answer: "A와 B는 물과 식용유의 관계처럼 서로 용해되지 않는 성질을 가진다.",
  ...
  },
  {
    ...
    answer: "염산과 반응하여 이산화 탄소 기체를 발생시킨다.",
  ...
  },
  {
    ...
    answer: "수소 40 mL가 모두 반응하면 수증기 40 mL가 생성된다.",
