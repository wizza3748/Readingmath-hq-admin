...
export const initialDiagnosticTests: Omit<DiagnosticTest, 'createdAt' | 'totalQuestions'>[] = [
  ...
  { id: 29, semesterName: '초등 3학년 1학기 (쌍둥이)', status: '검수전' },
  { id: 30, semesterName: '초등 3학년 2학기 (쌍둥이)', status: '검수전' },
  { id: 31, semesterName: '초등 4학년 1학기 (쌍둥이)', status: '검수전' },
  { id: 32, semesterName: '초등 4학년 2학기 (쌍둥이)', status: '검수전' },
  { id: 33, semesterName: '초등 5학년 1학기 (쌍둥이)', status: '검수전' },
  { id: 34, semesterName: '초등 5학년 2학기 (쌍둥이)', status: '검수전' },
  { id: 35, semesterName: '초등 6학년 1학기 (쌍둥이)', status: '검수전' },
  { id: 36, semesterName: '초등 6학년 2학기 (쌍둥이)', status: '검수전' },
  { id: 37, semesterName: '중등 1학년 1학기 (쌍둥이)', status: '검수전' },
  { id: 38, semesterName: '중등 1학년 2학기 (쌍둥이)', status: '검수전' },
  { id: 39, semesterName: '중등 2학년 1학기 (쌍둥이)', status: '검수전' },
  { id: 40, semesterName: '중등 2학년 2학기 (쌍둥이)', status: '검수전' },
  { id: 41, semesterName: '중등 3학년 1학기 (쌍둥이)', status: '검수전' },
...
export async function updateDiagnosticTestStatus(db: Firestore, testId: string, status: '검수전' | '검수완료') {
  ...
  await updateDoc(docRef, dataToUpdate)
    .catch(async (serverError) => {
      console.error("Firestore update failed:", serverError);
      const permissionError = new FirestorePermissionError({
        path: docRef.path,
        operation: 'update',
        requestResourceData: dataToUpdate,
