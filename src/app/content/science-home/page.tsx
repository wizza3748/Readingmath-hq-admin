...
const SCIENCE_BACKGROUNDS: Record<string, string> = {
    "초3-1": "https://readingmath.co.kr/build/assets/science_bg_main_3-1-DfFVbir3.svg",
    "초3-2": "https://readingmath.co.kr/build/assets/science_bg_main_3-2-CRtqdFic.svg",
    "초4-1": "https://readingmath.co.kr/build/assets/science_bg_main_4-1-JXygHH3t.svg",
    "초4-2": "https://readingmath.co.kr/build/assets/science_bg_main_4-2-C_mZ2WvX.svg",
    "초5-1": "https://readingmath.co.kr/build/assets/science_bg_main_5-1-FeYr__SF.svg",
    "초5-2": "https://readingmath.co.kr/build/assets/science_bg_main_5-2-rlL22Up1.svg",
    "초6-1": "https://readingmath.co.kr/build/assets/science_bg_main_6-1-ooRmqF3z.svg",
    "초6-2": "https://readingmath.co.kr/build/assets/science_bg_main_6-2-DZ5IImvW.svg",
    "중1-1": "https://readingmath.co.kr/build/assets/science_bg_main_7-1-BbLVcS_j.svg",
    "중1-2": "https://readingmath.co.kr/build/assets/science_bg_main_7-2-DrgWi_OM.svg",
    "중2-1": "https://readingmath.co.kr/build/assets/science_bg_main_8-1-BTNaVv7h.svg",
    "중2-2": "https://readingmath.co.kr/build/assets/science_bg_main_8-2-DLZ2Ufr-.svg",
    "중3-1": "https://readingmath.co.kr/build/assets/science_bg_main_9-1-C_8_-JaS.svg",
    "중3-2": "https://readingmath.co.kr/build/assets/science_bg_main_9-2-C1GdxYfL.svg",
    "고1-1": "https://readingmath.co.kr/build/assets/science_bg_main_7-1-BbLVcS_j.svg",
    "고1-2": "https://readingmath.co.kr/build/assets/science_bg_main_7-2-DrgWi_OM.svg",
};
...
export default function ScienceHomePage() {
    ...
    const firstProgressLabel = (() => {
        const course = SCIENCE_CURRICULA.find(c => c.course === selectedGradeTerm);
        if (!course || course.types.length === 0) {
            return "(1) 과학과 인류의 지속가능한 삶";
        }
        ...
        <div className="relative min-h-screen w-full overflow-hidden bg-[#081324] font-sans select-none text-white">
            ...
            <header className="fixed top-0 left-0 right-0 h-[56px] bg-[#091527] border-b border-[#142338] z-50 flex items-center justify-between px-5 shadow-md">
                ...
                <div className="flex items-end gap-1.5 h-full">
                    ...
                    <Link href="/content/science-free" className="h-[40px] flex items-center">
            ...
            {unstartedCount > 0 && latestUnstartedTask && (
                <Link href="/content/science-task-center" className="absolute top-[120px] right-6 z-40 block">
