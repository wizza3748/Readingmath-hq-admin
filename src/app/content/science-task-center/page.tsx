...
export default function ScienceTaskCenterPage() {
    ...
    return (
        <div className="relative min-h-screen w-full overflow-x-hidden bg-[#040714] font-sans text-[#cbd5e1] pb-32">
            ...
            <header className="fixed top-0 left-0 right-0 h-[56px] bg-[#070b1c]/80 backdrop-blur-md border-b border-white/[0.06] z-40 flex items-center justify-between px-6 shadow-[0_4px_30px_rgba(0,0,0,0.4)]">
                <Link href="/" className="flex items-center gap-2 cursor-pointer flex-shrink-0 group">
                    <div className="relative flex items-center justify-center h-8 w-8 rounded-lg bg-gradient-to-tr from-cyan-500 to-blue-600 p-[1.5px] transition-transform duration-300 group-hover:scale-105">
                        <div className="flex h-full w-full items-center justify-center rounded-[6px] bg-[#070b1c]">
                ...
                <div className="flex items-end gap-1 h-full">
                    ...
                    <div className="relative bg-[#0084ff] text-white px-6 h-[44px] rounded-t-[12px] rounded-b-none text-[14px] font-black flex items-center justify-center min-w-[95px] select-none shadow-[0_-4px_20px_rgba(0,132,255,0.25)] border-t border-x border-[#38bdf8]/35">
                        <span>과제 센터</span>
            ...
            <main className="relative max-w-5xl mx-auto px-6 pt-[90px] z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-10 pb-6 border-b border-white/[0.06]">
                    <div className="flex items-center gap-4">
                        <Link href="/content/science-home" className="p-3 bg-[#0a1226] hover:bg-[#111e3b] border border-white/[0.06] hover:border-white/[0.12] rounded-full transition-all group flex-shrink-0 shadow-lg hover:scale-105 active:scale-95">
                            <ArrowLeft className="h-5 w-5 text-cyan-300 group-hover:-translate-x-0.5 transition-transform" />
                        </Link>
                        <div>
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className="px-3 py-0.5 bg-gradient-to-r from-[#06b6d4]/20 to-[#0891b2]/20 text-[#22d3ee] text-[12px] font-black rounded-full border border-[#06b6d4]/30 shadow-[0_0_15px_rgba(6,182,212,0.15)]">과학</span>
                            </div>
                            <p className="text-[13.5px] text-[#94a3b8] mt-1 font-medium">배정된 과학과제를 확인하고 실력을 키워보세요.</p>
                        </div>
                    </div>

                    {/* 실시간 디버그 모드용 표시기 */}
                    <div className="mt-4 md:mt-0 px-4 py-2.5 bg-[#080d1d]/80 backdrop-blur-md border border-white/[0.08] rounded-2xl flex items-center gap-4 text-[12px] shadow-2xl">
                        <span className="font-extrabold text-[#0084ff] flex items-center gap-1.5">
                            <Sparkles className="h-3.5 w-3.5 animate-pulse" /> 디버그 보드
                        </span>
                        <div className="h-3.5 w-[1px] bg-white/[0.08]" />
                        <div className="flex items-center gap-3">
                            <span className="text-[#94a3b8]">미시작 <strong className="text-[#0084ff] font-mono ml-0.5">{unstartedTasks.length}</strong></span>
                ...
                {/* 3. <학습 현황 요약 영역> (글래스모피즘 적용으로 촌스러움 전면 제거) */}
                {completedCount > 0 && (
                    <div className="mb-12">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="relative overflow-hidden bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] rounded-2xl p-5.5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.03),0_10px_30px_rgba(0,0,0,0.3)] hover:border-white/[0.15] hover:bg-white/[0.04] transition-all duration-300 flex flex-col justify-between group">
                                <div className="absolute top-[-20%] right-[-20%] p-6 bg-[#06b6d4]/5 rounded-full blur-2xl group-hover:bg-[#06b6d4]/8 transition-colors duration-300 pointer-events-none" />
                            ...
                            {/* 카드 3: 제출 문항 수 */}
                            <div className="relative overflow-hidden bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] rounded-2xl p-5.5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.03),0_10px_30px_rgba(0,0,0,0.3)] hover:border-white/[0.15] hover:bg-white/[0.04] transition-all duration-300 flex flex-col justify-between group">
                                <div className="absolute top-[-20%] right-[-20%] p-6 bg-[#3b82f6]/5 rounded-full blur-2xl group-hover:bg-[#3b82f6]/8 transition-colors duration-300 pointer-events-none" />
                                <div className="flex items-center justify-between">
                                ...
                                <div className="mt-4 flex items-baseline gap-1">
                                    <span className="text-3xl font-black text-[#3b82f6] font-mono tracking-tight">{totalSubmittedProblems}</span>
                    ...
                    <div className="mb-14">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {ongoingTasks.map(task => {
                                ...
                                return (
                                    <div key={task.id} className="group relative bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] hover:border-cyan-500/40 rounded-2xl p-6.5 shadow-[0_12px_45px_rgba(0,0,0,0.35)] hover:shadow-[0_12px_40px_rgba(6,182,212,0.12)] transition-all duration-300 flex flex-col justify-between min-h-[210px] hover:-translate-y-1">
                                        ...
                                        <div>
                                            <div className="flex items-start justify-between gap-3 mb-2.5">
                                                <h3 className="text-[16px] font-bold text-white group-hover:text-cyan-200 transition-colors leading-snug break-keep tracking-tight">
                                                    {task.title}
                                                </h3>
                                                <select 
                                                    value={task.status} 
                                                    onChange={(e) => handleStatusChange(task.id, e.target.value as Task["status"])}
                                                    className="bg-[#091124] border border-white/[0.1] hover:border-white/[0.2] text-[#94a3b8] text-[11px] font-extrabold px-2 py-0.5 rounded-lg focus:outline-none cursor-pointer shadow-md select-none transition-colors"
                                                >
                                            ...
                                            {task.unitDisplayName && (
                                                <span className="inline-block px-2.5 py-0.5 bg-white/[0.04] text-[#a5f3fc] text-[11.5px] font-bold rounded-md border border-white/[0.04] leading-none mb-4">
                                                    {task.unitDisplayName}
                                                </span>
                                            )}
                                        </div>
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <div className="w-full h-3 bg-[#081023]/90 rounded-full overflow-hidden border border-white/[0.04] p-[1.5px]">
                                                <div 
                                        ...
                                        <div className="mt-5 pt-4 border-t border-white/[0.05] flex items-center justify-between">
                                            ...
                                            <button 
                                                ...
                                                className="px-4.5 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.35)] text-white text-[12px] font-extrabold rounded-xl shadow-lg transition-all duration-200 active:scale-95 flex items-center gap-1 group/btn"
                                            >
                ...
                {unstartedTasks.length > 0 && (
                    <div className="mb-14">
                        <div className="flex items-center gap-2.5 mb-5">
                            ...
                            <span className="bg-[#06b6d4]/10 text-[#06b6d4] border border-[#06b6d4]/20 px-2.5 py-0.5 rounded-full text-[12px] font-black font-mono shadow-[0_0_10px_rgba(6,182,212,0.1)]">{unstartedTasks.length}</span>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {unstartedTasks.map(task => (
                                <div key={task.id} className="group relative bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] hover:border-cyan-500/40 rounded-2xl p-6.5 shadow-[0_12px_45px_rgba(0,0,0,0.35)] hover:shadow-[0_12px_40px_rgba(6,182,212,0.08)] transition-all duration-300 flex flex-col justify-between min-h-[190px] hover:-translate-y-1">
                                    ...
                                    <div>
                                        <div className="flex items-start justify-between gap-3 mb-2.5">
                                            <h3 className="text-[16px] font-bold text-white group-hover:text-cyan-300 transition-colors leading-snug break-keep tracking-tight">
                                                {task.title}
                                            </h3>
                                            <select 
                                                value={task.status} 
                                        ...
                                        {task.unitDisplayName && (
                                            <span className="inline-block px-2.5 py-0.5 bg-white/[0.04] text-[#22d3ee] text-[11.5px] font-bold rounded-md border border-white/[0.04] leading-none mb-4">
                                                {task.unitDisplayName}
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="mt-4 pt-4 border-t border-white/[0.05] flex items-center justify-between">
                                        ...
                                        <button 
                                            ...
                                            className="px-4.5 py-2 bg-gradient-to-r from-cyan-600 to-cyan-800 hover:from-cyan-500 hover:to-cyan-700 hover:shadow-[0_0_20px_rgba(6,182,212,0.35)] text-white text-[12px] font-extrabold rounded-xl shadow-lg transition-all duration-200 active:scale-95 flex items-center gap-1 group/btn"
                                        >
                ...
                {scienceTasks.length === 0 && (
                    <div className="relative overflow-hidden bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] rounded-3xl p-20 text-center shadow-2xl">
                        ...
                        <ClipboardList className="h-16 w-16 text-cyan-400/40 mx-auto mb-4" />
                        <h3 className="text-lg font-black text-white">배정된 과제가 없습니다</h3>
                        <p className="text-sm text-[#94a3b8] mt-2">깨끗하게 모든 과제를 마쳤거나 배정된 과학 과제가 없습니다.</p>
                    </div>
                )}
            ...
            {startModalOpen && selectedTask && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    {/* Modal Content */}
                    <div className="relative bg-[#070b1c]/90 backdrop-blur-2xl border border-white/[0.12] rounded-3xl p-7 max-w-[420px] w-full shadow-[0_25px_60px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.06)] z-10 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="flex flex-col items-center text-center mt-4">
                            <div className="p-4 bg-cyan-500/10 rounded-full border border-cyan-500/20 mb-5 shadow-[0_0_25px_rgba(6,182,212,0.15)] animate-pulse">
                            ...
                            <div className="w-full grid grid-cols-2 gap-3.5">
                                ...
                                <button
                                    ...
                                    className="py-3.5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-[13.5px] font-extrabold rounded-xl shadow-lg hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all active:scale-95"
                                >
                                    풀기 시작
                                </button>
                            </div>
            ...
            {continueModalOpen && selectedTask && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-[#070b1c]/90 backdrop-blur-2xl border border-white/[0.12] rounded-3xl p-7 max-w-[420px] w-full shadow-[0_25px_60px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.06)] z-10 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="flex flex-col items-center text-center mt-4">
                            <div className="p-4 bg-cyan-500/10 rounded-full border border-cyan-500/20 mb-5 shadow-[0_0_25px_rgba(6,182,212,0.15)]">
