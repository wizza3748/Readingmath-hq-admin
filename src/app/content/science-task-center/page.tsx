...
export default function ScienceTaskCenterPage() {
    ...
    return (
        <div className={`relative min-h-screen w-full overflow-x-hidden ${isDarkMode ? 'bg-[#040714] text-[#cbd5e1]' : 'bg-[#f8fafc] text-[#334155]'} font-body pb-32 transition-colors duration-300`}>
            ...
            {isDarkMode ? (
                ...
                <>
                    <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[radial-gradient(circle,rgba(6,182,212,0.03)_0%,transparent_70%)] pointer-events-none z-0" />
                    <div className="absolute top-[30%] right-[-10%] w-[60%] h-[60%] rounded-full bg-[radial-gradient(circle,rgba(59,130,246,0.02)_0%,transparent_75%)] pointer-events-none z-0" />
                </>
            )}

            {/* 1. Global Navigation Bar (GNB) */}
            <header className={`fixed top-0 left-0 right-0 h-[56px] ${isDarkMode ? 'bg-[#070b1c]/80 border-white/[0.06] shadow-[0_4px_30px_rgba(0,0,0,0.4)]' : 'bg-white/80 border-slate-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.03)]'} backdrop-blur-md border-b z-40 flex items-center justify-between px-6 transition-all duration-300`}>
            ...
            <main className="relative max-w-5xl mx-auto px-6 pt-[90px] z-10">
                ...
                <div className={`flex flex-col md:flex-row md:items-center md:justify-between mb-10 pb-6 border-b ${isDarkMode ? 'border-white/[0.06]' : 'border-slate-200'}`}>
                    <div>
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className={`px-3 py-0.5 ${isDarkMode ? 'bg-gradient-to-r from-[#06b6d4]/20 to-[#0891b2]/20 text-[#22d3ee] border-[#06b6d4]/30' : 'bg-cyan-50 text-[#0891b2] border-[#a5f3fc]'} text-[12px] font-black rounded-full border shadow-[0_0_15px_rgba(6,182,212,0.15)]`}>과학</span>
                        </div>
                        <p className={`text-[13.5px] ${isDarkMode ? 'text-[#94a3b8]' : 'text-[#475569]'} mt-1 font-medium`}>과학과제를 확인하고 풀이할 수 있습니다.</p>
                    </div>
                ...
                {completedCount > 0 && (
                    <div className="mb-12">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            {/* 카드 3: 제출 문항 수 */}
                            <div className={`relative overflow-hidden ${isDarkMode ? 'bg-white/[0.02] border-white/[0.06] shadow-[inset_0_1px_1px_rgba(255,255,255,0.03),0_10px_30px_rgba(0,0,0,0.3)] hover:bg-white/[0.04]' : 'bg-white border border-slate-100 shadow-[0_6px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_10px_25px_rgba(0,0,0,0.04)]'} rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between group`}>
                                <div className={`absolute top-[-20%] right-[-20%] p-6 ${isDarkMode ? 'bg-[#3b82f6]/5 group-hover:bg-[#3b82f6]/8' : 'bg-blue-50 group-hover:bg-blue-100/50'} rounded-full blur-2xl transition-colors duration-300 pointer-events-none`} />
                                <div className="flex items-center justify-between">
                                ...
                                <div className="mt-4 flex items-baseline gap-1">
                                    <span className={`text-3xl font-black ${isDarkMode ? 'text-[#3b82f6]' : 'text-[#1d4ed8]'} font-mono tracking-tight`}>{totalSubmittedProblems}</span>
                                    <span className={`text-[13px] ${isDarkMode ? 'text-[#94a3b8]' : 'text-[#475569]'} font-black`}>문항</span>
                                </div>
                                <div className="mt-2.5 h-[1.5px] w-full bg-gradient-to-r from-[#3b82f6]/40 to-transparent" />
                            </div>
                                    ...
                                    <div key={task.id} className={`group relative ${isDarkMode ? 'bg-white/[0.02] border-white/[0.06] hover:border-cyan-500/40 shadow-[0_12px_45px_rgba(0,0,0,0.35)] hover:shadow-[0_12px_40px_rgba(6,182,212,0.12)]' : 'bg-[#f0f7ff] border border-blue-100/70 shadow-[0_4px_15px_rgba(30,41,59,0.02)] hover:border-blue-300'} rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between min-h-[210px] hover:-translate-y-1`}>
                                        ...
                                        <div>
                                            <div className="flex items-start justify-between gap-3 mb-2.5">
                                                <h3 className={`text-[16px] font-bold ${isDarkMode ? 'text-white group-hover:text-cyan-200' : 'text-[#1e293b] group-hover:text-[#1d4ed8]'} transition-colors leading-snug break-keep tracking-tight`}>
                                                    {task.title}
                                                </h3>
                                            </div>
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <div className={`w-full h-3 ${isDarkMode ? 'bg-[#081023]/90 border-white/[0.04]' : 'bg-slate-200/70 border-slate-300/40'} rounded-full overflow-hidden border p-[1.5px]`}>
                                                <div 
                                        ...
                                        <div className={`mt-5 pt-4 border-t ${isDarkMode ? 'border-white/[0.05]' : 'border-slate-200/50'} flex items-center justify-between`}>
                                            ...
                                            <button 
                                                ...
                                                className={`px-6 py-2 ${isDarkMode ? 'bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.35)]' : 'bg-[#1d4ed8] hover:bg-blue-700 hover:shadow-[0_4px_12px_rgba(29,78,216,0.2)]'} text-white text-[12px] font-extrabold rounded-xl shadow-lg transition-all duration-200 active:scale-95 flex items-center gap-1 group/btn`}
                                            >
                ...
                {unstartedTasks.length > 0 && (
                    <div className="mb-14">
                        <div className="flex items-center gap-2.5 mb-5">
                            ...
                            <span className={`${isDarkMode ? 'bg-[#06b6d4]/10 text-[#06b6d4] border-[#06b6d4]/20 shadow-[0_0_10px_rgba(6,182,212,0.1)]' : 'bg-cyan-50 text-[#0891b2] border border-cyan-100'} px-2.5 py-0.5 rounded-full text-[12px] font-black font-mono`}>{unstartedTasks.length}</span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {unstartedTasks.map(task => (
                                <div key={task.id} className={`group relative ${isDarkMode ? 'bg-white/[0.02] border-white/[0.06] hover:border-cyan-500/40 shadow-[0_12px_45px_rgba(0,0,0,0.35)] hover:shadow-[0_12px_40px_rgba(6,182,212,0.08)]' : 'bg-white border border-slate-100 shadow-[0_4px_15px_rgba(0,0,0,0.015)] hover:border-slate-300 hover:shadow-[0_6px_20px_rgba(0,0,0,0.025)]'} rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between min-h-[190px] hover:-translate-y-1`}>
                                    ...
                                    <div>
                                        <div className="flex items-start justify-between gap-3 mb-2.5">
                                            <h3 className={`text-[16px] font-bold ${isDarkMode ? 'text-white group-hover:text-cyan-300' : 'text-[#1e293b] group-hover:text-[#0891b2]'} transition-colors leading-snug break-keep tracking-tight`}>
                                                {task.title}
                                            </h3>
                                        </div>
                                        
                                        {task.unitDisplayName && (
                                            <span className={`inline-block px-2.5 py-0.5 ${isDarkMode ? 'bg-white/[0.04] text-[#22d3ee] border-white/[0.04]' : 'bg-cyan-50 text-[#0891b2] border border-cyan-100'} text-[11.5px] font-bold rounded-md leading-none mb-4`}>
                                                {task.unitDisplayName}
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className={`mt-4 pt-4 border-t ${isDarkMode ? 'border-white/[0.05]' : 'border-slate-200/50'} flex items-center justify-between`}>
                                        ...
                                        <button 
                                            ...
                                            className={`px-6 py-2 ${isDarkMode ? 'bg-gradient-to-r from-cyan-600 to-cyan-800 hover:from-cyan-500 hover:to-cyan-700 hover:shadow-[0_0_20px_rgba(6,182,212,0.35)]' : 'bg-[#1e293b] hover:bg-[#0f172a] text-white'} text-[12px] font-extrabold rounded-xl shadow-lg transition-all duration-200 active:scale-95 flex items-center gap-1 group/btn`}
                                        >
                ...
                {scienceTasks.length === 0 && (
                    <div className={`relative overflow-hidden ${isDarkMode ? 'bg-white/[0.02] border-white/[0.06] shadow-2xl' : 'bg-white border border-slate-100 shadow-lg'} rounded-3xl p-20 text-center`}>
                        ...
                        <p className={`text-sm ${isDarkMode ? 'text-[#94a3b8]' : 'text-[#64748b]'} mt-2`}>깨끗하게 모든 과제를 마쳤거나 배정된 과학 과제가 없습니다.</p>
                    </div>
                )}
            ...
            {startModalOpen && selectedTask && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    {/* Dimmed Background */}
                    <div className="absolute inset-0 bg-[#01030a]/90 backdrop-blur-md" />
                    
                    {/* Modal Content */}
                    <div className={`relative ${isDarkMode ? 'bg-[#070b1c]/90 border-white/[0.12] shadow-[0_25px_60px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.06)]' : 'bg-white border border-slate-200 shadow-2xl'} rounded-3xl p-8 max-w-[420px] w-full z-10 animate-in fade-in zoom-in-95 duration-200`}>
                        ...
                        <div className="flex flex-col items-center text-center mt-4">
                            <div className={`p-4 ${isDarkMode ? 'bg-cyan-500/10 border-cyan-500/20 shadow-[0_0_25px_rgba(6,182,212,0.15)]' : 'bg-cyan-50 border border-cyan-200 shadow-[0_0_15px_rgba(6,182,212,0.08)]'} rounded-full mb-5 animate-pulse`}>
                            ...
                            <div className="w-full grid grid-cols-2 gap-3.5">
                                <button
                                    onClick={() => { setStartModalOpen(false); setSelectedTask(null); }}
                                    className={`py-3.5 ${isDarkMode ? 'bg-white/[0.03] text-[#cbd5e1] border-white/[0.08] hover:bg-white/[0.08] hover:text-white hover:border-white/[0.15]' : 'bg-slate-50 border border-slate-200 text-[#475569] hover:bg-slate-100 hover:text-[#0f172a]'} text-[13.5px] font-extrabold rounded-xl shadow-md transition-all active:scale-95 shadow-md`}
                                >
                                    취소
                                </button>
                                <button
                                    onClick={confirmStartTask}
                                    className={`py-3.5 ${isDarkMode ? 'bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white hover:shadow-[0_0_20px_rgba(6,182,212,0.3)]' : 'bg-[#1e293b] hover:bg-[#0f172a] text-white'} text-[13.5px] font-extrabold rounded-xl shadow-lg transition-all active:scale-95`}
                                >
                                    풀기 시작
                                </button>
                            </div>
                    ...
                    <div className={`relative ${isDarkMode ? 'bg-[#070b1c]/90 border-white/[0.12] shadow-[0_25px_60px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.06)]' : 'bg-white border border-slate-200 shadow-2xl'} rounded-3xl p-8 max-w-[420px] w-full z-10 animate-in fade-in zoom-in-95 duration-200`}>
                        ...
                        <div className="flex flex-col items-center text-center mt-4">
                            ...
                            <div className="w-full grid grid-cols-2 gap-3.5">
                                ...
                                <button
                                    onClick={() => { setContinueModalOpen(false); setSelectedTask(null); }}
                                    className={`py-3.5 ${isDarkMode ? 'bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white hover:shadow-[0_0_20px_rgba(6,182,212,0.3)]' : 'bg-[#1d4ed8] hover:bg-blue-700 text-white'} text-[13.5px] font-extrabold rounded-xl shadow-lg active:scale-95`}
                                >
                                    계속 풀기
                                </button>
                            </div>
