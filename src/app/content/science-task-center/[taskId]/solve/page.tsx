...
export default function ScienceSolvePage(props: PageProps) {
  ...
  const handleConfirmSubmit = async () => {
    ...
    // 결과 화면으로 이동
    if (isPreview) {
      router.push(`/content/science-task-center/${taskId}/result?preview=true`);
    } else {
      router.push(`/content/science-task-center/${taskId}/result`);
    }
  };
    ...
    <div className="flex h-screen flex-col bg-gray-50 text-gray-900 transition-colors duration-200 dark:bg-gray-950 dark:text-gray-100">
      <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div className="flex items-center space-x-2.5 text-sm font-semibold">
          ...
          {/* 세로 구분선 */}
          <span className="h-3 w-px bg-gray-200 dark:bg-gray-850 mx-1" />
      ...
      <main className="flex flex-1 overflow-hidden">
        {/* 좌측 문제/풀이 영역 */}
        <section className="flex flex-1 flex-col overflow-y-auto p-8 lg:p-12 bg-white dark:bg-gray-950 border-r border-gray-100 dark:border-gray-850">
                ...
                {currentQuestion.type === "choice" ? (
                  ...
                  <div className="flex flex-col space-y-4 max-w-[360px] mx-auto w-full">
                    <input
                      ...
                      className="w-full text-center rounded-xl border border-gray-200 bg-white px-5 py-3.5 text-xl font-bold tracking-wider text-gray-800 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 dark:border-gray-800 dark:bg-gray-900 dark:text-white"
                    />
              ...
              <div className="flex flex-col h-full border border-gray-200 dark:border-gray-800 rounded-2xl bg-gray-50/50 dark:bg-gray-900/30 overflow-hidden">
                    ...
                    return (
                      <div 
                        ...
                        className={`p-3 rounded-xl border bg-white dark:bg-gray-900 flex flex-col gap-2.5 transition-all duration-150 ${
                          isActiveInput ? "border-emerald-500 dark:border-emerald-750 ring-2 ring-emerald-500/20" : "border-gray-250/50 dark:border-gray-800"
                        }`}
                      >
                          ...
                          {q.type === "choice" ? (
                                  ...
                                  <button
                                    ...
                                    className={`h-7 w-7 rounded-full border text-[11px] font-bold flex items-center justify-center transition active:scale-95 ${
                                      isSelected
                                        ...
                                        : "border-gray-250 bg-white text-gray-650 dark:border-gray-750 dark:bg-gray-855 dark:text-gray-450 hover:bg-gray-50"
                                    }`}
                                  >
                                    {["①", "②", "③", "④", "⑤"][cIdx] || choiceNum}
                                  </button>
                            ...
                            <div className="space-y-2">
                              <input
                                ...
                                placeholder="터치하여 입력"
                                className="w-full text-center rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm font-bold text-gray-800 focus:border-emerald-500 focus:outline-none dark:border-gray-800 dark:bg-gray-955 dark:text-white cursor-pointer hover:bg-gray-50/50"
                              />
                              
                              {/* 입력형 인라인 키패드 */}
                              {isActiveInput && (
                                <div className="w-full bg-gray-100 dark:bg-gray-850 p-3 rounded-xl border border-gray-200/50 dark:border-gray-750/50 animate-in slide-in-from-top-2 duration-150">
                                  <div className="grid grid-cols-5 gap-1.5">
                                    {[
                                      ...
                                      { label: "-", value: "-" },
                                      { label: "+", value: "+" },
                                      { label: "clear", value: "clear", cls: "bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-xs font-bold" },
                                      { label: "⌫", value: "delete", cls: "bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-xs font-bold" },
                                      
                                      { label: "✓ 확인", value: "confirm", colSpan: 5, cls: "bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm h-9 flex items-center justify-center rounded-lg shadow-sm" },
                                    ].map((btn, i) => {
                                      const gridCls = [
                                        btn.colSpan ? `col-span-${btn.colSpan}` : "",
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-850 dark:hover:bg-gray-750 text-gray-600 dark:text-gray-300 font-extrabold text-sm transition-all active:scale-95 flex items-center justify-center gap-1.5"
                  >
                    닫기
                  </button>
                </div>
      ...
      <footer className="flex h-20 items-center justify-between border-t border-gray-200 bg-white px-6 dark:border-gray-855 dark:bg-gray-900 z-10">
        ...
        <div className="text-sm font-bold text-gray-500 dark:text-gray-400">
          <span className="text-emerald-600 dark:text-emerald-400">{currentIdx + 1}</span> / {questions.length}
        </div>

        <div className="flex items-center space-x-3">
          {isPreview && (
            <button
              onClick={() => router.push(`/content/science-task-center/${taskId}/explanation?preview=true`)}
      ...
      {showUnenteredModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-950 border border-gray-100 dark:border-gray-800 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-900 border border-gray-100 dark:border-gray-800 animate-in fade-in zoom-in-95 duration-150">
            ...
            <textarea
              ...
              className="w-full h-32 rounded-xl border border-gray-200 bg-white p-4 text-sm text-gray-800 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 dark:border-gray-800 dark:bg-gray-950 dark:text-white mb-6 resize-none"
            />
            <div className="flex justify-end space-x-3">
              <button
                onClick={() => {
              ...
              <button
                ...
                className="rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 shadow-md shadow-emerald-500/10 disabled:opacity-50"
              >
