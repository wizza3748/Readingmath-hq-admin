...
const HELP_SECTIONS = [
  {
    ...
    lines: [
      ...
      "삭제된 과제는 모든 통계에서 제외됩니다.",
      "배정 취소된 학생 과제는 학생 배정 건수, 학생 제출완료 건수, 제출률, 평균 점수 집계에서 제외됩니다.",
    ],
  },
  {
    title: "과제 상태 기준",
  ...
  {
    title: "학생 배정 건수 산정 기준",
    lines: [
      "학생 배정 건수는 배정 유지 상태인 학생 과제를 합산한 값입니다.",
      "미시작, 진행중, 제출완료 상태의 학생 과제가 포함됩니다.",
      "동일 과제에 동일 학생이 반 배정과 개별 배정으로 중복된 경우 1건으로 집계됩니다.",
    ],
  },
  {
    title: "학생 제출완료 건수 산정 기준",
    lines: [
      "학생 제출완료 건수는 제출완료 상태인 학생 과제를 합산한 값입니다.",
      "미시작과 진행중 상태의 학생 과제는 포함되지 않습니다.",
      "동일 학생 과제의 재수행 결과가 여러 개인 경우 1건으로 집계됩니다.",
    ],
  },
  {
    title: "제출률 계산 기준",
    lines: [
      "제출률은 학생 배정 건수 대비 학생 제출완료 건수의 비율입니다.",
      "학생 배정 건수가 0건인 경우 제출률은 0%로 표시됩니다.",
    ],
  },
  {
    title: "평균 점수 계산 기준",
    lines: [
      ...
      "동일 학생 과제의 재수행 결과가 여러 개인 경우 최신 결과가 적용됩니다.",
      "학생 제출완료 건수가 0건인 경우 평균 점수는 -로 표시됩니다.",
    ],
  },
];
